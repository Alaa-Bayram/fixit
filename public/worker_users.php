...
<div class="premium-chat-container">
    <section class="users-sidebar">
        <div class="user-header">
            <img src="php/<?php echo htmlspecialchars($profile_image)?>" alt="Profile" class="user-avatar">
            <div class="user-info">
...
<script src="javascript/worker_users.js"></script>
